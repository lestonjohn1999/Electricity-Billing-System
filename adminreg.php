                    ...
                    <form  method="post">
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="text1" id="text1" type="text" value="" placeholder="Branch ID" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                            <input name="text2" id="text2" type="text" value="" placeholder="Branch Location ID" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                        <input name="text3" id="text3" type="text" value="" placeholder="Branch Location Name" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="text4" id="text4" type="email" value="" placeholder="Branch Email" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="text5" id="text5" type="text" value="" placeholder="Branch Phone" required="">
                            </div>
                        </div>
    ...
    if(isset($_POST["button"]))
{
        ...
        //$usname = $_POST['usn'];
        $pas = $_POST['psw'];
        $user_reg = "insert into branch values ($id, '$lid','$lname', '$email','$phno', '$pas' );";
        //die($user_reg);
        //$user_login = "insert into login values ( '$usname', '$pas' , $lid);";
        //$user_con = "insert into consumption values ($id, '$lid', '$lname', '$mtr', '$email','$phno', '$lid', '$pas' );";
        $user_sub = mysqli_query($con, $user_reg) or die(mysqli_error($con));
        //$user_creg = mysqli_query($con, $user_login) or die(mysqli_error($con));
        echo "Branch User successfully inserted!!!";
}   
        ?> 
</body>
