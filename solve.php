...
<body>
    ...
    <section class="banner-bottom py-5">
        ...
        echo "Click to Solve the Query!!!!";
                        ...
                        <br>
                        <div class="content-input-field">
                            <button type="submit" class="btn" name="button">Solve</button>
                        </div>
                    </form></div>
                </div>
            </div>
   ...
   if(isset($_SESSION['cid']))
    {
        ...
        $up = "UPDATE problem SET status = 'S' where cid = ".$_SESSION['cid'].";";
        $exe = mysqli_query($conn, $up) or die(mysqli_error($conn));
        $del = "DELETE from problem where status='S';";
        $exe2 = mysqli_query($conn,$del);
        echo "Query Solved Succefully!!!!";
    }
    ?>
     <!-- footer -->
