...
session_start();
	if(isset($_SESSION['cid']))
	{
        ...
        $check = "SELECT * FROM consumer WHERE cid = '".$_SESSION['cid']."' ;";
        $result = mysqli_query($conn,$check);
        $row = mysqli_fetch_row($result);?>
        <div id="det"><?php
        echo "<head><h1>Details:</h1></head><br><br>";
        ?><div id="deta"><?php
        echo "Customer ID: $row[0]<br>";
        echo "Customer Name: $row[1] $row[2]<br>";
        echo "Meter Code: $row[3]<br>";
        echo "Email-ID: $row[4]<br>";
