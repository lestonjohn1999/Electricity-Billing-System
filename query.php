...
<body>
    ...
    <!--/login -->
        ...
        <div class="container">
            <head><h1>Upload Queries</h1></head>
                ...
                <div class="content-bottom">
                    <form method="post" >
                        ...
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="text2" id="text1" type="text" value="" placeholder="Problem Description" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="text3" id="text1" type="text" value="" placeholder="Address" required="">
                            </div>
                        </div>
                         <div class="content-input-field">
...
<?php
    if(isset($_POST["button"]))
    {
        ...
        $r2 = $_POST['text2'];
        $r3 = $_POST['text3'];
        $check = "insert into problem values ($r1, '$r2', '$r3', 'NS');";
        $result = mysqli_query($conn,$check) or die(mysqli_error($conn));
        echo "Query Updated Succesfully!!!";
    }
?>
    <!-- footer -->
