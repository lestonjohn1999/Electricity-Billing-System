...
<head>
    ...
    <style type="text/css">
        ...
        th{border-right: 3px solid skyblue;
...
<?php
    ...
    if(isset($_SESSION['cid']))
    {
        ...
        $result = $conn->query($check);?><div id="tab"><?php
        echo "<table>";
        echo "<tr><th>Consumer ID   </th><th>Description     </th><th>Address     </th></tr>";
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            echo "<tr><td>";
            echo $row['cid'];
            $cid_new = $row['cid'];
            echo "</td><td>";?><a href="solve.php"><?php
            echo $row['probdescript'];$_SESSION['cid'] = $cid_new ?></a><?php
            echo "</td><td>";
            echo $row['adress'];
            echo "</td></tr>";
        }
