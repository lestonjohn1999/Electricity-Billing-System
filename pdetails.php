...
<body>
    ...
    <section class="banner-bottom py-5">
        ...
        echo "Click to get Consumer Details who have Paid the Bill Amount";
        $check = "SELECT * FROM consumption WHERE status = 'P';";
        ...
        if (mysqli_num_rows($result) == 1)
        {
            ...
            $_SESSION['cid']= $cid_new;
                        ...
                        <br>
                        <div class="content-input-field">
                            <button type="submit" class="btn" name="button"><a href="paydetails.php">Get Details</a></button>
                        </div>
                    </form></div>
                </div>
            </div>
