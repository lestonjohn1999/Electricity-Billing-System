...
<body>
            ...
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    ...
                    <div class="forms ml-auto">
                        <a href="clogout.php" class="btn"><span class="fa fa-user-circle-o"></span> Sign Out</a>
                    </div> 
   ...
   <div class="col-lg-8 col-md-10 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-life-ring"></span> Pay Bill</h4>
                        <p class="cont-wthree-para mb-3 text-capitalize"><a href="pay.php">Click Here to pay bill</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-comments"></span> Upload Queries</h4>
                        <p class="cont-wthree-para mb-3 text-capitalize"><a href="query.php">Click Here to upload your queries</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-map"></span> Bill Amount</h4>
                    <p class="cont-wthree-para mb-3 text-capitalize"><a href="bill.php">Click Here to get Bill Details</a>
                    </p>
                    </div>
                </div>
            </div>
