...
<body>
    ...
    <section class="banner-bottom py-5">
        ...
        echo "Click to get Consumer Details who have Not Paid the Bill Amount";
                                ?>
                            </div>
                            </div>
                        </div>
                        <br>
                        <div class="content-input-field">
                        <button type="submit" class="btn" name="button"><a href="npaydetails.php">Get Details</a></button>
                        </div>
                    </form></div>
                </div>
            </div>
...
//session_start();
    if(isset($_POST["button"]))
    {
        ...
        $check = "SELECT * FROM consumption WHERE status = 'NP';";
        ...
        if (mysqli_num_rows($result) == 1)
        {
            ...
            //header('Refresh:0;url:npaydetails.php');
        }
    }
        ?>
        <!-- footer -->
