...
session_start();
    if(isset($_SESSION['cid']))
    {
        ...
        ?>
        <div id="det"><?php
        echo "<head><h1>Bill Details:</h1></head><br><br>";
        ?><div id="deta"><?php
        echo "Customer ID: $row[1]<br>";
        echo "Units Consumed: $row[2]<br>";
        echo "Total Units Consumed: $row[3]<br>";
        echo "Amount Payable: $row[5]<br>";
        
        //echo "</center>";   ?></div></div><?php
    }
?>
 <!-- footer -->
