                ...
                <div class="nav-top-wthree">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="active"><a href="ccontact.php">Contact</a></li>
                        </ul>
                    </nav>
                    <!-- //nav -->
...
<center>
                <div class="col-lg-8 col-md-10 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        ...
                        <p class="cont-wthree-para mb-3 text-capitalize">for general queries, including property Sales and constructions, please email us at <a href="mailto:info@example.com">electhelp@example.com</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        ...
                        <p class="cont-wthree-para mb-3 text-capitalize">we are ready to help! if you have any queries or issues, contact us for support <label>+91 99884 47710</label>.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-map"></span> Others</h4>
                        <p class="cont-wthree-para mb-3 text-capitalize">we are ready to help! if you have any queries or issues, contact us for support <label>+91 98765 43210</label>.</p>
                    </div>
                </div>
            </div>
        </div>
