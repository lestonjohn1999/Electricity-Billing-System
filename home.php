...
<body>
   ...
   <div class="col-lg-8 col-md-10 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-pencil-square-o"></span> Admin Registration</h4>
                        <p class="cont-wthree-para mb-3 text-capitalize"><a href="adminreg.php">Click Here to Register</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-user-circle-o"></span> Admin Login</h4>
                        <p class="cont-wthree-para mb-3 text-capitalize"><a href="adlogin.php">Click Here to Login</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-pencil-square-o"></span> Consumer Registration</h4>
                    <p class="cont-wthree-para mb-3 text-capitalize"><a href="register.php">Click Here to Register</a>
                    </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        <h4 class="text-uppercase mb-4"><span class="fa fa-user-circle-o"></span> Consumer Login</h4>
                    <p class="cont-wthree-para mb-3 text-capitalize"><a href="login.php">Click Here to Login</a>
                    </p>
                    </div>
                </div>
            </div>
